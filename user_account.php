    ...
    <div class="col-md-12">
      <div class="address-info">
        ...
        <div class="info-body">
          ...
          <p><strong>Province: </strong><?php echo $data['address']?> </p>
...
<!-- Update Address Information Modal -->
<div class="modal fade" id="updateAccountInfoModal" tabindex="-1" role="dialog" aria-labelledby="updateAccountInfoModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <h5 class="modal-title" id="updateAccountInfoModalLabel">Update Address Information</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
  <div class="modal-body">
    <p>Current Address: <address><?php echo $data['user_street'].', ',$data['user_barangay'].', '. $data['user_city'].', '. $data['address'];?></address></p>
    <div class="form-group">
